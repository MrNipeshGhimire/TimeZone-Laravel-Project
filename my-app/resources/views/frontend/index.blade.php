...
<main>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url({{asset('frontend/img/gallery/gallery1.png')}});"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url({{asset('frontend/img/gallery/gallery2.png')}});"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-12">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('frontend/img/gallery/gallery3.png')}});"></div>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12  col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('frontend/img/gallery/gallery4.png')}});"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            ...
                            <div class="popular-caption">
                                <h3><a href="{{route('frontend.detail', $item->id)}}">{{$item->title}}</a></h3>
        ...
        <!--? Watch Choice  Start-->
        <div class="watch-area section-padding-20">
            <div class="container">
